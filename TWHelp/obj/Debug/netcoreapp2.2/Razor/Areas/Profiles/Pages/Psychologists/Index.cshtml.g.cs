#pragma checksum "D:\Projects\проект по авпз\TWHelp\Areas\Profiles\Pages\Psychologists\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "629a127b1d84e425ca836ead2a449483db5ff64e"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"629a127b1d84e425ca836ead2a449483db5ff64e", @"/Areas/Profiles/Pages/Psychologists/Index.cshtml")]
        ...
        data.forEach(item => {
            ...
            newDiv.getElementById('psycho-like-like').addEventListener('click', function (element) {
                ...
                if (element.target.classList.contains('fas')) {
                    ...
                    container.querySelector('#psycho-like').className += 'far';
                    container.querySelector('#psycho-like').className -= 'fas';
                }
                else {
                    addLikeToProfile(item.id);
          ");
            WriteLiteral(@"          container.querySelector('#psycho-like').className += 'fas';
                    container.querySelector('#psycho-like').className -= 'far   ';
                }
            });
