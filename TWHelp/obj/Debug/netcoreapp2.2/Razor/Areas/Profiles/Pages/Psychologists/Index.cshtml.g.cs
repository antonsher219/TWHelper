#pragma checksum "D:\Projects\проект по авпз\TWHelp\Areas\Profiles\Pages\Psychologists\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "da83615be52a8598d8a95ad6a6913470784f5da2"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"da83615be52a8598d8a95ad6a6913470784f5da2", @"/Areas/Profiles/Pages/Psychologists/Index.cshtml")]
...
<div class=""container-fluid"">
    <div class=""row d-flex flex-column"">
        ...
        <div class=""col-12 col-sm-11 col-md-10 mx-auto my-3"">
            ...
            ");
            EndContext();
            BeginContext(455, 440, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "da83615be52a8598d8a95ad6a6913470784f5da25066", async() => {
                BeginContext(558, 330, true);
                WriteLiteral(@"
                <div class=""col-9"">
                    <input type=""text"" class=""form-control"" id=""search-text"" placeholder=""John Johnson"">
                </div>
                <div class=""col-3"">
...
<style>
    ...
    #psycho-like-like:hover {
        ...
        color: orange;
            ...
            WriteLiteral("le>\r\n\r\n<script>\r\n    const webRoot = \'http://\' + \'");
            EndContext();
            BeginContext(3267, 13, false);
#line 87 "D:\Projects\проект по авпз\TWHelp\Areas\Profiles\Pages\Psychologists\Index.cshtml"
                            Write(Model.WebRoot);
...
#line 88 "D:\Projects\проект по авпз\TWHelp\Areas\Profiles\Pages\Psychologists\Index.cshtml"
                 Write(Model.IsUserPsycho);

#line default
#line hidden
            EndContext();
            BeginContext(3325, 4553, true);
            WriteLiteral(@"';
    ...
    async function searchForPsycoProfiles(event) {
        ...
        await fetch(webRoot + '/api/search/psychologist/' + text, {
                method: 'GET'
            })
            .then(response => response.json())
            .then(data =>");
            WriteLiteral(@" _displayItems(data))
    ...
    function _displayItems(data) {
        ...
        data.forEach(item => {
            ...
            if (item.isAccountActivated == 'true') {
                newDiv.getEleme");
            WriteLiteral(@"ntById('psycho-confirm').textContent = 'yes';
            }
            else {
            ...
            ");
            WriteLiteral(@"        addLikeToProfile(item.id);
