...
namespace TWHelp.API
{
    ...
    public class TopicsController : ControllerBase
    {
        ...
        //    {
        //        var topic = _db.Topics.Include(top => top.Creator).First(top => top.Id.ToString().Equals(id));
        //        ViewBag.Topic = topic;
        //        var comments = _db.Comments.Include(com => com.Creator).Where(com => com.ParentTopic.Id == topic.Id);
        //        if (_db.Comments.Count() > 0)
        //        {
        //            ViewBag.Comments = _db.Comments
        //                .Include(com => com.Creator)
        //                .Where(com => com.ParentTopic.Id == topic.Id && !com.IsDeleted);
        //        }
        //        return View();
        //    }
        //    else
        ...
        public async Task<ActionResult<Topic>> Delete(int id)
        {
            Topic topic = await _context.Topics
                .SingleOrDefaultAsync(top => top.Id == id);
